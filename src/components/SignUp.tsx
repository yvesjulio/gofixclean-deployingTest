    ...
    <section className="flex flex-col md:flex-row min-h-[calc(100vh-64px)] overflow-hidden">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <button
          type="button"
          onClick={() => navigate("/")}
          className="absolute top-6 right-16 flex items-center gap-2 text-white font-medium px-6 py-1 rounded-full border border-gray-400 hover:border-brandOrange hover:text-brandOrange transition-colors"
        >
          Back
        </button>
      </div>
        ...
        Forgot password?
          ...
          <div className="flex flex-col gap-5 w-full">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm whitespace-nowrap font-medium">OR CONTINUE WITH</p>
              <div className="flex-1 border-t border-gray-300"></div>
            </div>
