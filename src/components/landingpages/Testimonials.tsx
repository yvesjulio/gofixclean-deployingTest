...
const Testimonials: React.FC = () => {
  ...
  const providers: Provider[] = [
    {
      name: "Pasclaine Uwase",
      job: "HR Admin",
      image: "",
      rating: 5,
      quote: "As a busy working mom, I don't have time to search for home service providers GoFix&Clean makes it easy to find trusted cleaners and handymen Love the video/images upload  feature!",
    },
    {
      name: "Marie Fidelle",
      job: "Office Manager",
      image: "",
      rating: 4,
      quote: "I don't have time to search for home service providers GoFix&Clean makes it easy to find trusted cleaners and handymen !",
    },
    {
      name: "Ndorimana Jean Bosco",
      job: "Home Owner",
      image: "",
      rating: 3,
