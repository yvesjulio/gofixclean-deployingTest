        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center px-4">
            ...
            <p className="text-gray-600 text-base sm:text-base md:text-sm leading-relaxed">
              Sign up and tell us about <br/>your skills, experience, and <br/>the services you offer.
            </p>
          </div>
          ...
          <div className="text-center px-4">
            ...
            <p className="text-gray-600 text-base sm:text-base md:text-sm leading-relaxed">
              Complete our verification <br/>process to build trust with<br/> potential clients.
            </p>
          </div>
          ...
          <div className="text-center px-4">
            ...
            <p className="text-gray-600 text-base sm:text-base md:text-sm leading-relaxed">
              Receive booking requests, <br/>accept jobs, and get paid for<br/> your work.
            </p>
          </div>
