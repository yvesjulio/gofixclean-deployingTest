      ...
      <div className="max-w-8xl mx-auto flex flex-col md:flex-row justify-center gap-6 md:gap-10">
        ...
        <div className="flex flex-col items-start text-left space-y-4 border border-gray-300 rounded-xl p-6 bg-white shadow-lg md:w-5/11">
          ...
          <p className="text-gray-500 text-sm leading-relaxed line-clamp-4">
            {"To connect every household with trusted, verified service providers, making quality home services accessible, affordable, and hassle-free for everyone. Pay only after the job is done to your satisfaction with our secure system."}
          </p>
        </div>
