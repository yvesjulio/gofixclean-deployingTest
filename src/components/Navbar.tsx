  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-6 md:px-16 h-16 bg-white shadow-md">
        ...
        <div className="hidden md:flex items-center gap-10 text-brandText font-medium">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <button className="bg-brandText text-white px-4 py-2 rounded-md transition-all duration-300 ease-out hover:bg-brandText hover:scale-[1.02]">
            Sign Up
          </button>
        </div>
      ...
      >
        <div className="px-6 py-6 text-brandText space-y-6">
          ...
          <div className="flex flex-col gap-4 text-base">
            <p className="cursor-pointer transition active:text-brandOrange active:scale-[1.02]">
              Find a service
            </p>
            <p className="cursor-pointer transition active:text-brandOrange active:scale-[1.02]">
              Become a provider
            </p>
            <p className="cursor-pointer text-black transition active:text-brandOrange active:scale-[1.02]">
              Sign in
            </p>
          </div>

          <button className="w-full bg-brandText text-white py-3 rounded-md font-medium transition-all duration-200 ease-out active:bg-brandText active:scale-[1.02]">
            Sign Up
          </button>
        </div>
      </div>
