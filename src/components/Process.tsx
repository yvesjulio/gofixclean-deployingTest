  ...
  const categories = [
    {
      ...
      icon: <FiSearch className="text-2xl text-[#096647]" />,
      bgColor: "bg-[#91DFC5]",
    },
    {
      ...
      icon: <FaUserCheck className="text-2xl text-[#096647]" />,
      bgColor: "bg-[#91DFC5]",
    },
    {
      title: "Book & Schedule",
      ...
      icon: <FaRegCalendarCheck className="text-2xl text-[#096647]" />,
      bgColor: "bg-[#91DFC5]",
    },
    {
      ...
      icon: <GoStar className="text-2xl text-[#096647]" />,
      bgColor: "bg-[#91DFC5]",
    },
  ];
